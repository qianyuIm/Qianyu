...
public class EmptyDataSetView: UIView {
    ...
    internal var topOffset: CGFloat = 100
    ...
    internal func setupConstraints() {
        ...
        if (topOffset != 0 && constraints.count > 0) {
        ...
        if let customView = customView {
            ...
            let topConstraint = NSLayoutConstraint(item: customView, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1.0, constant: 0.0)
