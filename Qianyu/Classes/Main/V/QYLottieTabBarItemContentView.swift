...
enum LottieColorKeyPathType: String {
...
class QYLottieTabBarItemContentView: ESTabBarItemContentView {
    lazy var lottieView: AnimationView = {
        ...
        // 改变颜色
        /*let colorKeyPath = AnimationKeypath(keypath: colorKeyPathType.rawValue)
        let colorValueProvider = ColorValueProvider(Color(r: 0, g: 0, b: 0, a: 1))
        lottieView.setValueProvider(colorValueProvider, keypath: colorKeyPath)*/
        return lottieView
    }()
    var lottieName: String
    var colorKeyPathType: LottieColorKeyPathType
    init(lottieName: String,
         colorKeyPathType: LottieColorKeyPathType) {
        self.lottieName = lottieName
        self.colorKeyPathType = colorKeyPathType
